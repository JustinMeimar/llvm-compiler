...
public:
  ...
  virtual std::any visitFunctionDeclarationDefinition(GazpreaParser::FunctionDeclarationDefinitionContext *ctx) override; 

  virtual std::any visitProcedureDeclarationDefinition(GazpreaParser::ProcedureDeclarationDefinitionContext *ctx) override; 
